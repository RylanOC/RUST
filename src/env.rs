lazy_static! {
    ...
    pub static ref CLIENT_SECRET: String = client_secret();
}
...
pub fn setup() {
    ...
    info!("Client secret set: {}", *CLIENT_SECRET);
...
fn client_secret() -> String {
    std::env::var(CLIENT_SECRET_ENV_VAR).unwrap_or(DEFAULT_CLIENT_SECRET.to_owned())
}
